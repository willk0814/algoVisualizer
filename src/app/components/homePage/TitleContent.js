            ...
            <motion.div className="flex flex-col justify-between m-2 space-y-2">
              <motion.p 
                ...
                variants={{
                    initial: { opacity: 0, y: '25px'},
                    animate: { opacity: 1, y: 0 },
                  }}>Welcome and thank you for checking out this project.  I built this while studying for technical interviews because I wanted a way to visualize the algorithms that I was using.  I hope you enjoy using it and take some value from it!  Don't hesitate to contact me with any suggestions or feedback</motion.p>
